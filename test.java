...
public class test{
	public static void main(String[] args) throws Exception {
		...
		aux cosas = new aux();
		File mapa = new File("/home/matt/Proyectos/sigma/mapas/salta/lugares.shp");
		File mapa2 = new File("/home/matt/Proyectos/sigma/mapas/salta/lugares2.shp");
		File mapa3 = new File("/home/matt/Proyectos/sigma/mapas/salta/lugares3.shp");
        if (mapa == null) {
            return;
        }
